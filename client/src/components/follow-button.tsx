...
//         } else {
//           // For preview, set a random follow status
...
//     checkFollowStatus()
//   }, [username, session, initialIsFollowing])
...
//       toast({
//         title: "Success",
//         description: isFollowing ? `You have unfollowed ${username}` : `You are now following ${username}`,
//       })

//       // Refresh the page to update follower counts
//       router.refresh()
//     } catch (error: any) {
//       console.warn(`Failed to ${isFollowing ? "unfollow" : "follow"} user:`, error)

//       // For preview, toggle the follow status anyway
//       setIsFollowing(!isFollowing)
//       toast({
//         title: "Preview Mode",
//         description: isFollowing ? `You have unfollowed ${username}` : `You are now following ${username}`,
