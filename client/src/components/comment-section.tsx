...
//       // For preview, add a mock comment
//       const mockComments = getMockComments(1)
//       const mockComment = {
//         ...mockComments[0],
//         content: newComment,
//         user: session.user,
...
//       toast({
//         title: "Comment added (Preview)",
//         description: "Your comment has been added in preview mode",
//       })
//     } finally {
...
//       // For preview, remove the comment anyway
//       setComments(comments.filter((comment) => comment.id !== commentId))

//       toast({
//         title: "Comment deleted (Preview)",
//         description: "Your comment has been deleted in preview mode",
//       })
//     }
//   }
